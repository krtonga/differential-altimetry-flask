...
class ApiTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sensor_fixed = "{\"sensor_id\":\"fixed 1\",\"fixed\":true, \"lat\":5.394125,\"lon\":-23.287345,\"alt\":841}"
        self.sensor_rover = "{\"sensor_id\":\"rover 1\",\"fixed\":false}"

        # If you update this mock, please also update readings_1_plus
        self.readings_1 = '''[{
            "sensor_id": "sensor1",
            "calibration": true,
            "time": 1521245271.408,
        ...
        # this is readings_1, plus an additional reading. It is used to test duplicate entries.
        self.readings_1_plus = '''[{
            "sensor_id": "sensor1",
            "calibration": true,
            "time": 1521245271.408,
            "height": 0.94,
    ...
    def test_reading_get_count_for_sensor_id(self):
        self.client.post('/readings', data=self.readings_1)
        self.client.post('/readings', data=self.readings_2)
